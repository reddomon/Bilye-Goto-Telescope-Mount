...
#define RA_MAX_SPEED  10000     // Set Max Speed of Stepper (Faster for regular movements)
#define RA_MAX_ACCELERATION  10000 // Set Acceleration of Stepper


#define DEC_MAX_SPEED  10000     // Set Max Speed of Stepper (Faster for regular movements)
#define DEC_MAX_ACCELERATION  10000 // Set Acceleration of Stepper

//FOCUS axis
#define FOCUS_MAX_SPEED  10000     // Set Max Speed of Stepper (Faster for regular movements)
