...
void setup(void) {
  ...
  DEC_90 = RA_90;   // How much in microSteps the DEC motor have to turn in order to make 6h = 90 degrees;
...
//local mean sidereal hour angle
