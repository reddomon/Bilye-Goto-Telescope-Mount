#ifndef STARS_H  //definition check
#define STARS_H

#include <Arduino.h>

//star coords for alignment procedure retrieved from rDuinoscope.
//Definition of the ALIGNMENT Stars. Add as many stars as you like in here
//defined as a vector because we have to get list element count easily for csv parsing
std::vector<String> Stars = {           
